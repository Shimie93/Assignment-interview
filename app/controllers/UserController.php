...

{
    ...
    public function secondPage(){
        ...
        return View::make('secondPage')->with('user', Auth::user());
    }

    public function secondPageV(){

        return View::make('secondPageV')->with('user', Auth::user());
    }

    public function uploadpage(){

        return View::make('product')->with('user', Auth::user());
    }
    ...
    public function thirdPage(){
        ...
        return View::make('thirdPage')->with('user',Auth::user());
