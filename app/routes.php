...
Route::get('secondPage','UserController@secondPage');
Route::get('secondPageV','UserController@secondPageV');
Route::get('thirdPage','UserController@thirdPage');

Route::get('uploadpage','UserController@uploadpage');

Route::post('uploadproduct/{request}','UserController@uploadproduct');
